...
def preco_com_desconto(preco, percentual_desconto):
...
def dias_perdidos_por_fumar(cigarros, anos):
   ...
   tempo_vida_perdido = cigarros * ((anos * 365) * 10)
   dias_perdidos = (tempo_vida_perdido) / 1440
